...
graph_data_file = 'graph_data/data_vs_lamda_table_dummy_dev.txt'
	...
	for l_2 in lamda_2:
		for dp in dropout:
			#for _,cur_epoch in enumerate(range(0, 65, 5)):
				...
				load_model_file = 'models/'+model_file #+str(trained_max_epochs-1)+'.pkl.gz'
