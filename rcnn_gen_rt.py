...
class Model(object):
    ...
    def evaluate_data(self, batches_x, batches_y, eval_func_gen, eval_func, sampling=False):
        ...
        print p1, n, total_generate_time, total_encode_time
        return tot_obj/n, tot_mse/n, tot_diff/n, p1/n, tot_a/n, total_generate_time, total_encode_time 
...
def main():
    ...
    if args.train:
        ...
        if args.load_model: 
            ...
            say("model both gen enc loaded successfully.\n")
        else:
            model.ready()
