...
class Model(object):
    ...
    def train(self, train, dev, test, rationale_data, trained_max_epochs = None):
        ...
        train_generator = theano.function(
                inputs = [ self.x, self.y ],
                outputs = [ self.encoder.obj, self.encoder.loss, \
                                self.encoder.sparsity_cost, self.z, self.word_embs, gnorm_e, gnorm_g, self.generator.probs2, self.generator.avg_embs, self.generator.avg_1_6, self.generator.avg_emb_middle],
